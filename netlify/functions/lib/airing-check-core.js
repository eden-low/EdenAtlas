...
// out of netlify/functions/anime-airing-check.js so the CORE can be unit/integration tested with
...
// published/production-context deploy). See netlify/functions/anime-airing-check.js's own header
