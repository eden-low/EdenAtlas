...
// independently in netlify/functions/__tests__/airing-check-core.test.js against
// runAiringCheck() directly. Run with: node netlify/functions/__tests__/anime-airing-check.test.js
