// Deterministic tests for the airing-reminder CORE logic (netlify/functions/lib/
...
// isolation follow-up). Run with: node netlify/functions/__tests__/airing-check-core.test.js
// (or `npm run test:functions`).
//
// This file used to live inside netlify/functions/__tests__/anime-airing-check.test.js, calling
