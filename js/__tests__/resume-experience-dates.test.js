...
// already established by js/__tests__/discover-card-actions-layout.test.js), not a
...
//
// Run with: node js/__tests__/resume-experience-dates.test.js (or `npm run test:frontend`).
...
const CAREER_SRC = fs.readFileSync(path.join(ROOT, "career.js"), "utf8");
const PORTFOLIO_SRC = fs.readFileSync(path.join(ROOT, "portfolio.js"), "utf8");
