...
// js/__tests__/discover-foryou.test.js (mediaCard()/renderCardActions() run for real, not
// reimplemented) -- kept self-contained/duplicated per this repo's per-test-file convention.
//
// Run with: node js/__tests__/discover-card-actions-layout.test.js
...
const DISCOVER_SRC = fs.readFileSync(path.join(ROOT, "discover.js"), "utf8");
