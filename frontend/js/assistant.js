...
// still has to pass the Function's own auth/owner checks (see backend/netlify/functions/assistant.js).
...
// backend/netlify/functions/lib/tools.js's list_calendar/toolDefsForScopes). Two distinct predicates,
...
//     submit guard below and backend/netlify/functions/assistant.js's matching server-side reject.
...
// backend/netlify/functions/lib/qwen.js's createProvenanceTracker) of which real tool(s) actually ran
