...
// (backend/netlify/functions/lib/firebase-admin.js), and Firebase's own "Web Push certificates" ARE a
...
// `stage=... code=...` convention backend/netlify/functions/assistant.js's logAuthStageFailure() already
