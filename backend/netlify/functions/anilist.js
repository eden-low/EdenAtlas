...
//
// Production route: /.netlify/functions/anilist (source lives at backend/netlify/functions/anilist.js,
...
//
// Owner-only authorization reuses the EXACT approach backend/netlify/functions/assistant.js already
...
// access — see backend/netlify/functions/__tests__/anilist.test.js. Production wiring is at the bottom.
...
function buildProductionDeps() {
  ...
  function ensureApp() {
    ...
    // lib/firebase-admin.js's assertProjectMatchesBuildContext() for what this guards against.
