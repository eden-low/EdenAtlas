...
// lives at backend/netlify/functions/assistant.js, which is structurally excluded from the static
...
// filtering, coordinate validation) is duplicated locally in backend/netlify/functions/lib/tools.js,
...
// Qwen endpoint, or network access — see backend/netlify/functions/__tests__/assistant.test.js. The
...
function createHandler(deps) {
  return async function handler(event) {
    ...
    // backend/netlify/functions/lib/firebase-admin.js for the full history and the parsing/normalization
    // logic itself.
    try {
