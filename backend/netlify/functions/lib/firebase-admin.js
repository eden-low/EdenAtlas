...
// backend/netlify/functions/assistant.js called a lazy `getApp()` *inside* `verifyIdToken()`, and the
...
// backend/netlify/functions/assistant.js were still written against firebase-admin's LEGACY namespace
...
// see backend/netlify/functions/__tests__/assistant.test.js's "real package" smoke test, which is what
