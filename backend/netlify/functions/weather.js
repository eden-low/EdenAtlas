...
//
// Production route: /.netlify/functions/weather (source lives at backend/netlify/functions/weather.js,
...
//
// Unlike backend/netlify/functions/assistant.js, there is NO Owner-only check here — weather is shown to
...
// access — see backend/netlify/functions/__tests__/weather.test.js. Production wiring is at the bottom
// of this file.
function createHandler(deps) {
  return async function handler(event) {
    ...
    // shares (or is exhausted by) the same in-memory counter backend/netlify/functions/assistant.js uses
